//Lorenzo Bracci
//05-10-2019
//This is a program based on BFS which can answer questions of the type: "Find the a path from X to Y"
...
if(st.contains(word)){//checks if the word is already in the hash map
  ...
  states.push(word);
      ...
      BreadthFirstPaths path = new BreadthFirstPaths(graph, st.get(departure));
